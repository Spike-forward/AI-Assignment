...
const ANIME_KEYWORDS = [
  ...
  // ===== 職業相關 =====
  'anime student character',
  'anime school girl',
  'anime school boy',
  'anime warrior character',
  'anime samurai character',
  'anime ninja character',
  'anime mage character',
  'anime knight character',
  'anime soldier character',
  'anime maid character',
  'anime idol character',
  
  // ===== 類型相關 =====
  'anime hero character',
  'anime villain character',
  'anime protagonist',
  'shounen anime character',
  'shoujo anime character',
  ...
  'spy x family character',
  'chainsaw man character',
  'tokyo revengers character',
  'blue lock character'
];
